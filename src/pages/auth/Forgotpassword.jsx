            ...
            <div>
                ...
                <div>
                    <div className='mt-3 flex flex-col gap-y-4 text-white'>
                        <button className=' active:scale-[.98] active-duration-75 hover:scale-[1.01] ease-in-out transition-all py-4 rounded-xl bg-blue-500 text-white font-bold'> Reset Password
                        </button>
                    </div>
                </div>
